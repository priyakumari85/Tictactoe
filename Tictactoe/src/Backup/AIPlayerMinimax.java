...
import java.util.*;
	...
	public class AIPlayerMinimax extends AIPlayer {
	   ...
	   private int[] minimax(int depth, Moves player) {
	      ...
	      if (nextMoves.isEmpty() || depth == 0) {
	         ...
	         for (int[] move : nextMoves) {
	            ...
	            // Undo move
	            cells[move[0]][move[1]].content = Moves.EMPTY;
	         }
	      }
	   ...
	   private boolean hasWon(Moves thePlayer) {
	      int pattern = 000000000;  // 9-bit pattern for the 9 cells
	      for (int row = 0; row < ROWS; ++row) {
	         for (int col = 0; col < COLS; ++col) {
